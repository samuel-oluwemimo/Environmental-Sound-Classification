...
class AudioProcessor:
    ...
    def audio_process_chunk(self, audio_data):
...
class AudioClassifier:
    ...
    def load_model(self):
        ...
        checkpoint = torch.load("/models/model.pth", map_location=self.device)
    ...
    def inference(self, request: InferenceRequest):
        ...
        spectrogram = self.processor.audio_process_chunk(audio_data)
...
def main():
    audio_data, sample_rate = sf.read("clapping.wav")
